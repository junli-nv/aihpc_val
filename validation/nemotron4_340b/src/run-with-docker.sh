...
CASE=/tmp/pretrain_llama3_8b_bf16_2nodes_tp2_pp4_cp1_vpNone_1mbs_16gbs_fn_or_script
md5sum ${CASE}
ssh -p 2222 L20-GPU-30 "cat > ${CASE}" < ${CASE}
ssh -p 2222 L20-GPU-30 md5sum ${CASE}
