...
class dool_plugin(dool):
    ...
    def discover(self, *objlist):
        ...
        for subdirname in os.listdir(self.ibdirname):
            if not os.path.isfile(os.path.join('/sys/class/infiniband', subdirname, 'ports/1/counters/port_rcv_data')) and not os.path.isfile(os.path.join('/sys/class/infiniband', subdirname, 'ports/1/counters_ext/port_rcv_data_64')): continue
